...
inferential test for the beta double-stance-vs-swing contrast.
...
identical to standing for this contrast, see NOTES.md). Reads the
pre-reduced (already double-stance/swing-averaged, standing-baselined)
sub-{sub}_ersp_{double_stance,swing}.npy written by prepana05.
...
Output
------
results/pipeline/<dataset>/qc/<dataset>_betaphase_stats.txt
"""
...
from src.config import DATASET, SUBJECTS, DIR_QC, PIPELINE_TFR_FMAX, TFR_FMIN
...
lines.append("=" * 55)
lines.append("Normalization: dB relative to standing baseline")
...
out_path = DIR_QC / f"{DATASET}_betaphase_stats.txt"
